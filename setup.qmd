...
- **The books exercises** - <https://github.com/njtierney/mbg-exercises>. We will discuss how to "automagically" open this in the course
...
Paper and a pen is perfect. There is nothing to buy.

We draw plots by hand a few times during the day, before we build them in ggplot2. I want you to have a picture of what you are aiming at before you start typing, and the quickest way to get one is to draw it badly on a bit of paper.

The sketches are rough on purpose. Mine certainly are, and you will see a few of them in this book.

A tablet works too if you would rather. I draw on a reMarkable for class, but I always keep an A2 art sketch pad on my desk for sketches.
