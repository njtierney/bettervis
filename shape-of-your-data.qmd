...
This is a similar thing we made in @sec-anatomy, run in the other direction. There
...
This is the benefits of tidy data, and ggplot: your data links to the plot, and the plot links to the data.
