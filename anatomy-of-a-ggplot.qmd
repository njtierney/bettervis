...
- The following packages installed: tidyverse, naniar.
...
::: {.callout-note title="My sketching process" collapse="true"}
...
- Label each axis: 
  ...
  - sea temperature on the y axis. 
- Sketch the data values as circles on the page.
...
Take a couple of minutes to assess what you see in the plot above.

Answer these questions:

1. How is this different to your sketch?
2. What do see in the data - what is the story?
3. Is there something in here that you would want to explore?

:::

## Creating plots in ggplot

OK, let's walk through how to create the plot using ggplot2. Here is the code that produced the above plot:
...
Let's take @fig-elnino apart, and take another look at the code
...
across, `sea_temp_c` up, Those live inside `aes()`.
...
Get them to replicate this plot.

Then, get them to change air temp to humidity
...
Then get them to draw the same plot, but adding colour:
...
Now show them the ggplot with colour. Notice two clouds of data points?
...
Notice when we remove the colour, the story isn't as clear?
