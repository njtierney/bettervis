...
2. There is a set of instructions saying which column goes where - Those live inside `aes()`: `air_temp_c` across the x axis, `sea_temp_c` up the axis
...
3. Can you draw this plot, with `humidity` on the y axis?
...
**Data**: Data frame you are plotting (this chapter, next chapter)
...
**Aesthetics**: How columns map onto visual features (this chapter)
...
**Scales**: How data values change into different positions, and colours (@sec-computed)
